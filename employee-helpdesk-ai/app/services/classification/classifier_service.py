...
from app.services.prompts.prompt_builder import build_messages
from app.schemas.response import (
    ClassificationApiResponse,
    TicketClassificationResponse,
)
from app.services.security.prompt_injection import is_prompt_injection
from app.services.llm.exceptions import PromptInjectionError
from app.services.cost.cost_calculator import CostCalculator
from app.core.logging_config import logger
from app.services.prompts.prompt_selector import PromptSelector
...
class ClassifierService:
    ...
    def classify(
        ...
        if is_prompt_injection(employee_message):
            logger.warning(
        ...
        messages = build_messages(
            employee_message, selected_version
        )
